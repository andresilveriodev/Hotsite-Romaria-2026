...
export const fixedScheduleGroups: FixedScheduleGroup[] = [
  {
    id: "fixa-geral",
    title: "Programação diï¿½ria fixa",
    items: [
      {
        id: "fixa-1",
        time: "5h",
  ...
  },
  {
    ...
    items: [
      { id: "missa-local-1", time: "6h e 19h30", title: "Missas da programaï¿½ï¿½o diï¿½ria", location: "Praça do Santuário Basílica", category: "missas" },
      { id: "missa-local-2", time: "8h, 10h30, 15h, 17h30 e 22h", title: "Missas da programaï¿½ï¿½o diï¿½ria", location: "Santuário Basílica", category: "missas" },
      { id: "missa-local-3", time: "9h, 12h, 15h e 17h", title: "Missas da programaï¿½ï¿½o diï¿½ria", location: "Canteiro de Obras do Novo Santuário", category: "missas" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "confissoes-1", time: "6h às 21h", title: "Confissï¿½es", location: "Subsolo do Santuário Basílica", category: "daily" },
    ],
  },
  {
    id: "fixa-especiais",
    ...
    items: [
      ...
      { id: "especial-05", time: "05/07", title: "0h, 2h, 4h, 6h, 8h, 10h30, 12h, 13h30 e 15h, alï¿½m das missas da Matriz, Vila São Cottolengo, Igreja do Santíssimo Redentor e Carmelo", location: "Programação especial", category: "missas" },
...
export const dateScheduleEntries: ScheduleEntry[] = [
  ...
  { id: "2606-7", dateId: "26-06", dateLabel: "26/06 - Sexta-feira", time: "18h", title: "10ª Romaria da Polícia Civil", location: "Terminal Padre Pelï¿½gio", category: "romarias" },
  ...
  { id: "2706-2", dateId: "27-06", dateLabel: "27/06 - Sábado", time: "9h", title: "Romaria dos Acólitos e Coroinhas", location: "Concentraï¿½ï¿½o no altar central da Praça do Santuário", category: "romarias" },
  ...
  { id: "2706-7", dateId: "27-06", dateLabel: "27/06 - Sábado", time: "17h", title: "7ª Romaria Motociclista", location: "Terminal Padre Pelï¿½gio", category: "romarias" },
  ...
  { id: "2706-11", dateId: "27-06", dateLabel: "27/06 - Sábado", time: "19h30", title: "Participação das pastorais do Vicariato para a Evangelizaï¿½ï¿½o da Arquidiocese de Goiânia", location: "Praça do Santuário Basílica", category: "shows" },
  { id: "2706-12", dateId: "27-06", dateLabel: "27/06 - Sábado", time: "21h30", title: "Acolhida e bï¿½nï¿½ï¿½o da Romaria do Colégio e Faculdade Aphonsiano", location: "Basílica", category: "daily" },
  ...
  { id: "2906-1", dateId: "29-06", dateLabel: "29/06 - Segunda-feira", time: "7h30", title: "Romaria dos Carros de Boi, Cavaleiros e Muladeiros com bï¿½nï¿½ï¿½o", location: "Praça da Matriz", category: "romarias" },
  ...
  { id: "0507-9", dateId: "05-07", dateLabel: "05/07 - Domingo | Dia da Festa", time: "17h30", title: "Procissão Luminosa e Celebração de Encerramento", location: "Saindo da Matriz atï¿½ a Praça do Santuário Basílica", category: "shows" },
